...
class App extends React.Component {
    ...
    componentDidMount() {
        ...
        if(this.state.link==="/quiz" && String(window.location.href).slice(-5)==="/quiz" && this.state.count<4){
        ...
        return(
            <BrowserRouter>
                <div className="main">
                    ...
                    <Button id="button"className={this.state.css} onClick={this.chgBtn} hidden={this.state.isHidden} >{this.state.btnName}
